...
public class Main {
    ...
    static PlanetSystem system = new PlanetSystem("Solar System");
    ...
    public static void mainTask() {
        ...
        System.out.println("Earth has a distance of " + planetSystemList.get(whatSystem).getPlanet("Earth").distanceToCentralBody(0, NaturalSatellite.Degree.DEGREES) + "km to the Sun at 0 degrees");
        System.out.println("Earth has a distance of " + planetSystemList.get(whatSystem).getPlanet("Earth").distanceToCentralBody(90, NaturalSatellite.Degree.DEGREES) + "km to the Sun at 0 degrees");
        System.out.println("Earth has a distance of " + planetSystemList.get(whatSystem).getPlanet("Earth").distanceToCentralBody(180, NaturalSatellite.Degree.DEGREES) + "km to the Sun at 0 degrees");
        System.out.println("Earth has a distance of " + planetSystemList.get(whatSystem).getPlanet("Earth").distanceToCentralBody(270, NaturalSatellite.Degree.DEGREES) + "km to the Sun at 0 degrees");
        System.out.println("Earth has a distance of " + planetSystemList.get(whatSystem).getPlanet("Earth").distanceToCentralBody(360, NaturalSatellite.Degree.DEGREES) + "km to the Sun at 0 degrees");

        System.out.println();
        //2.6
        System.out.println("2.6");
        System.out.println("At a distance of 147054707km, Earth has a velocity of " + planetSystemList.get(whatSystem).getPlanet("Earth").orbitingVelocity(147054707, NaturalSatellite.UnitType.KILOMETER) + "km/s");
        System.out.println("At a distance of 147778223km, Earth has a velocity of " + planetSystemList.get(whatSystem).getPlanet("Earth").orbitingVelocity(147778223, NaturalSatellite.UnitType.KILOMETER) + "km/s");
        System.out.println("At a distance of 149554637km, Earth has a velocity of " + planetSystemList.get(whatSystem).getPlanet("Earth").orbitingVelocity(149554637, NaturalSatellite.UnitType.KILOMETER) + "km/s");
        System.out.println("At a distance of 151374279km, Earth has a velocity of " + planetSystemList.get(whatSystem).getPlanet("Earth").orbitingVelocity(151374279, NaturalSatellite.UnitType.KILOMETER) + "km/s");
        System.out.println("At a distance of 152141035km, Earth has a velocity of " + planetSystemList.get(whatSystem).getPlanet("Earth").orbitingVelocity(152141035, NaturalSatellite.UnitType.KILOMETER) + "km/s");

        System.out.println();
        //2.7
        System.out.println("Planet System toString:\n" + planetSystemList.get(whatSystem).toString());
        System.out.println();

        System.out.println("Celestial body toString:\n" + planetSystemList.get(whatSystem).getPlanet("Earth").toString());
        System.out.println();

        System.out.println("Celestial body toString:\n" + planetSystemList.get(whatSystem).getCenterStar().toString());
        System.out.println();

        //3.1
        System.out.println("At a distance of 149554637km, Earth has a velocity of " + planetSystemList.get(whatSystem).getPlanet("Earth").orbitingVelocity(152141035, NaturalSatellite.UnitType.METERS) + "m/s");
        System.out.println();
            ...
            case MAIN:
                ...
                switch (new UserInput().getString()) {
                    ...
                    case "Exit":
                        ...
                        break;
                    case "u":       //"temp"
                        SaveFile.saveFile_V2_5(planetSystemList);
                        break;
                    case "v":       //"temp"
